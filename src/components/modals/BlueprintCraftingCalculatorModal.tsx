  ...
  return (
    <Modal show={showModal} onHide={() => handleClose()}>
      ...
      <Modal.Body>
        ...
        {props.blueprint.materialCosts &&
        props.blueprint.materialCosts!.length > 0 ? (
          <>
            <div className="mb-3">
              {props.blueprint.materialCosts.map(
                (material: BlueprintMaterialCost) => {
                  const numMaterialStacks = Math.ceil(
                    material.cost / getStackSize(material.name)
                  );
                  return (
                    <div key={material.name} className="mb-1">
                      {material.name}{" "}
                      <span className="badge bg-primary">{material.cost}</span>{" "}
            ...
            <div className="mb-3">
              <label htmlFor="quantityToCraft" className="form-label">
                      ...
                      <div className="row">
                        ...
                        <div className="col-sm">
                          <input
                            ...
                            type="number"
                            value={material.cost * quantityToCraft}
                            className="w-100"
                            readOnly={true}
                          />
                        </div>
